...
class Asker:
    ...
    def ask(self, question: str) -> AskResult:
        ...
        if not chunks or chunks[0].similarity < self._threshold:
            return AskResult(answer=REFUSAL_MESSAGE, refused=True, citations=[])
        ...
        return AskResult(answer=generation.answer, refused=generation.refused, citations=citations)
